...
if __name__ == '__main__':
    ...
    print('bert/encoder/transformer/attention/self:', sum(x.numel() for x in model.attention.atn.parameters()))
    print('bert/encoder/transformer/LayerNorm_0:', sum(x.numel() for x in model.attention.add_1.parameters()))
    print('bert/encoder/transformer/ffn/intermediate/dense/kernel:', sum(x.numel() for x in model.attention.ffn.parameters()))
    print('bert/encoder/transformer/LayerNorm_1:', sum(x.numel() for x in model.attention.add_2.parameters()))
